...
--@TODO fix setAwesomeUtility function
--keybinding.setAwesomeUtility(awesome)
keybinding.setTagSwitching(9)
-- {{{ Key bindings
-- fix for setAwesomeUtility
globalkeys = awful.util.table.join(
    keybinding.getGlobalKeys(),
    -- Standard program
    awful.key(
        { modkey, "Control" }, "r",
        awesome.restart,
...
-- }}}
awful.spawn.with_shell("compton --vsync opengl -cb")
